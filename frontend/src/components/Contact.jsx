            ...
            <form className="space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <Input id="name" placeholder="Your name" className="pl-10 bg-[#0b0221]/50 border-violet-500/30 focus:border-violet-400 text-white placeholder-white/60" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input id="email" placeholder="Your email" className="pl-10 bg-[#0b0221]/50 border-violet-500/30 focus:border-violet-400 text-white placeholder-white/60" />
                </div>
              </div>

              <div>
                <label htmlFor="message" className="block text-sm font-medium mb-1 text-white">Message</label>
                <Textarea id="message" placeholder="Your message" rows={4} className="bg-[#0b0221]/50 border-violet-500/30 focus:border-violet-400 text-white resize-none placeholder-white/60" />
              </div>

              <Button className="w-full bg-gradient-to-r from-violet-600 to-fuchsia-500 hover:opacity-90 transition-opacity border-none text-white font-medium">
                Send Message
              </Button>
            </form>
          </div>
          ...
          <div className="flex flex-col justify-center space-y-8 md:pl-10">
            <div className="flex flex-col space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-medium mb-1 text-white">Our Location</h4>
                  <p className="text-white/90">1234 Innovation Drive, Tech City, TC 10101</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-medium mb-1 text-white">Email Us</h4>
                  <p className="text-white/90">contact@3dstudio.com</p>
                </div>
              </div>
              
              <div className="flex items-start space-x-4">
                <div className="p-3 bg-[#160c36]/70 rounded-lg border border-violet-500/20">
                  <Phone size={20} className="text-violet-300" />
                </div>
                <div>
                  <h4 className="font-medium mb-1 text-white">Call Us</h4>
